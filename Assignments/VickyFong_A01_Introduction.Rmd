...
> Answer: Before taking a "Data Science in Global Change Ecology" course in my senior year of college that taught R and Git, I mostly taught myself R when I needed to use it for research projects. I analyzed biological and ecological data mostly in Microsoft Excel in my most recent job the last three years as a research assistant for manta ray research nonprofit.

2. Are there any components of the course about which you feel confident?

> Answer: General coding in R, data exploration, wrangling and visualizations

3. Are there any components of the course about which you feel apprehensive?

> Answer: Time series and spatial analyses
...
> Answer: https://github.com/ENV872/EDE_Fall2024
