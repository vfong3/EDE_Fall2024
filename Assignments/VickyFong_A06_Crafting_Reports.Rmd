...
| Date | 2018-2019 |
| Souce | EPA Air Quality System (AQS) |
...
```{r Figure 1:, echo=FALSE, fig.align='left', fig.height=2.5, fig.cap="2018 monthly Ozone levels"}
ozone_2018 <- epa_data %>%
  filter(Year == "2018") %>%
...
```{r Figure 2:, echo=FALSE, fig.align='left', fig.height=2.5, fig.cap= " 2019 monthly Ozone levels"}
ozone_2019 <- epa_data %>%
  filter(Year == "2019") %>%
  mutate(Month = as.factor(Month)) %>%
  na.omit(Ozone) %>%
...
## Git Repository
https://github.com/vfong3/EDE_Fall2024
